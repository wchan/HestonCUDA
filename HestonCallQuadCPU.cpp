...
inline double HestonP(double kappa, double theta, double sigma, double rho,
...
inline double Hestf(double phi, double kappa, double theta, double sigma,
...
inline void legendre(int ind, double* quad_1d_point, 
...
inline double* quad_(double a, double b, int N, double kappa, double theta,
        double sigma, double rho, double v0, double r, double T,
        double s0, double K, int type) {
